...
DAEMON_SRC_NAMES := \
    ...
    audio.c config.c ipc.c overlay.c art_decode.c nowplaying.c info_views.c gl_quad.c \
...
DAEMON_HDR_NAMES := \
    ...
    audio.h config.h ipc.h overlay.h art_decode.h nowplaying.h info_views.h gl_quad.h \
...
TESTS := test-color test-module_registry test-wiring_render test-audio test-config-router test-overlay test-art_decode test-scene test-ipc test-render_params test-presets test-playlist test-backend test-cli test-visualizer-null test-visualizer-select test-scene_router test-info_views
